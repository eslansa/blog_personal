  ...
  return (
    <>
      <div className='flex flex-col items-center justify-center mb-2 p-2 text-sm dark:bg-gray-950 border dark:border-gray-90 text-justify'>
        ...
        <h1 className="text-2xl font-bold mb-4">¡Hola! Soy Eslán.</h1>
        <p className="mb-4 text-center font-sans text-lg">
          Apasionado del desarrollo frontend, me defino como una persona con ganas de aprender, muy creativo y espontáneo. Me gustan los retos. Estoy en la universidad terminando mis estudios y trabajando a la vez.
        </p>
